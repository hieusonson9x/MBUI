...
<body class="nav-md">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									</i> Chỉnh sửa thông tin nhóm quyền
								</h2>
							...
							<div class="x_content">
								<div class="" role="tabpanel" data-example-id="togglable-tabs">
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#tab_content1">Thông tin chung</a></li>
										<li><a data-toggle="tab" href="#tab_content2">Danh sách quyền</a></li>
									</ul>
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade active in"
											...
											<br>
											<form id="form-role"
												action="<s:url action = "update" namespace='/web/grouprole'/>"
												data-parsley-validate
												class="form-horizontal form-label-left" method="post">
												<input type="hidden" name="${_csrf.parameterName}"
													value="${_csrf.token}" /> <input type="hidden"
													name="groupRole.groupRoleId"
													value="<s:property value="groupRole.groupRoleId"/>" />
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield class="form-control col-md-7 col-xs-12"
															...
															value="%{groupRole.groupRoleCode}" required="required"
															readonly="true" id="ip-role-code" />
													</div>
												</div>
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="groupRole.groupRoleName" id="groupRoleName"
												...
												<div class="item form-group">
													...
													<input type="hidden" id="parentGroupRole11" value="<s:property value="parentGroupRole"/>">
														<input
															...
															autocomplete="off" list="bro" name="parentCode" id="parentCode"
															class="form-control col-md-7 col-xs-12">
														<datalist id="bro">
												...
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<textarea class="form-control" rows="3"
															name="groupRole.description" id ="reason">
															<s:property value='groupRole.description' />
						                        ...
						                        Vô hiệu
															...
															<s:else>
																<input type="radio" class="flat" name="groupRole.active"
																	value="1" /> Hoạt động
						                        	<input type="radio" class="flat"
																	name="groupRole.active" value="0" checked /> Vô hiệu
						                        </s:else>
														</p>
													</div>
												</div>
												...
												<div class="form-group" style="text-align:right;">
													<div class="col-md-6 col-md-offset-3">
														...
														<button id="send" class="btn btn-default"
															onclick="saveGroupRole()" type="button">
															 Lưu
														</button>
													</div>
							...
							<div class=""
								...
								<ul class="to_do" id="ul-role">
									<s:iterator value="allRoles">
										<li>
											<p>
												<s:if test="%{checkInList(exitsRoles)}">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/grouprole/editgr.js"></script>
