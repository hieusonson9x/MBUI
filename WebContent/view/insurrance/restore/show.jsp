						...
						<div class="x_panel">
							<div class="container">
											...
											<div class="x_content">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="item form-group">
															<label class="control-label col-md-6 col-sm-6 col-xs-12"
																for="firstName">Mã RM<span class={required:true}>*</span></label>
															<div class="col-md-6 col-sm-6 col-xs-12">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="item form-group">
															<label class="control-label col-md-6 col-sm-6 col-xs-12"
																for="firstName">Thời hạn bảo hiểm<span
																class={required:true}>*</span></label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input class="form-control"
													...
													<div class="col-md-6">
														<div class="item form-group">
															<label class="control-label col-md-6 col-sm-6 col-xs-12"
																for="firstName">Thời hạn khoản vay</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input class="form-control" type="text"
																	readonly="readonly"
														...
														<div class="item form-group">
															<label class="control-label col-md-6 col-sm-6 col-xs-12"
																for="firstName">Ngày hiệu lực BH</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
																<s:if test="insurrance.disbursementDate==null">
																	<input class="form-control" type="text"
																		...
																		value="dd/mm/yyyy" name="insurrance.disbursementDate" />
																</s:if>
																<s:else>
																	<input class="form-control" type="text"
																		readonly="readonly" id="disbursementDate"
														...
														<div class="item form-group">
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
																...
																<s:if test="insurrance.statusContract==5">
																	<input class="form-control col-md-7 col-xs-12"
																		readonly="readonly" value="Hoãn lại">
																</s:if>
												...
												<s:iterator value="insurranceLogs">
													<tr>
														...
														<td>
															...
															Ngày sinh :<s:property value="oldBirthday" /><br>
														...
														<td>
															...
															Ngày sinh :<s:property value="newBirthday" /><br>
								...
								<div style="text-align: center;">
									<s:url var="show" action="i2getFromrestore" namespace="/web/insurrance">
										<s:param name="getId">
											<s:property value="insurrance.id"></s:property>
										</s:param>
									</s:url>
									<a href="${show}" class="btn btn-default"> Khôi phục</a> 
									<a class="btn btn-default"
										href="<s:url action='i2listRestore' namespace='/web/insurrance'/>"> Đóng
									</a>
								</div>
							</div>
						</div>
