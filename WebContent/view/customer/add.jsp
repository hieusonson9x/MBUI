					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="container">
								...
								<form id="fromAdd"
									action="<s:url action = "addCustomer" namespace="/web/customer"/>"
											...
											<div class="x_content">
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield class="form-control col-md-7 col-xs-12" type="text"
															placeholder="Mã Khách Hàng" name="customer.customerCode" id="customer-code" />
													</div>
												</div>
												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.fullname"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.birthday"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														 <!-- <input type="radio" value="1"
															name="customer.sex">nam
														 <input type="radio" value="0"
															name="customer.sex">nữ -->
														<s:radio list="#{'1':'Nam','0':'Nữ'}" name="customer.sex"></s:radio>
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" id="cmtnd" name="customer.cmtnd"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
													<s:textfield class="form-control" placeholder="Ngày cấp" type="text" name="customer.dateRange" id="dateRange"/>
													</div>
												</div>
												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.issuedBy"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.address"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.phoneNumber"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.mergeStatus"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.job"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.groupJob"
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:textfield type="text" name="customer.averageIncome"
															placeholder="Thu nhập bình quân" class="form-control col-md-7 col-xs-12" id = "" />
													</div>
												</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var validator = $("#fromAdd").validate({
				 rules : {
						"customer.customerCode" : {required : true,maxlength :20,CODE : "required CODE"} ,
