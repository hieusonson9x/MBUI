...
<body class="nav-md">
	       ...
	       <div class="right_col" role="main">
				 <div class="row">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="row">
                            	<div class="col-md-12">
	                            	<label class="col-md-3 control-label" style="padding-top: 7px;text-align: right;">Loại báo cáo</label>
	                            	<div class="col-md-3">	
	                            		<select class="form-control" id="sel1" name="typeReport">
									        ...
									        <option value="4">Hợp đồng đóng phí định kỳ</option>
									         ...
									         <option value="6">Thay đổi thông tin hợp đồng</option>
									          <option value="7">Báo cáo hợp đồng đang chưa giải quyết</option>
									      </select>
	                           		</div>
	                           	</div>
	                           	<br></br>
                            	...
                            	<div class="col-md-12">
	                            	<label class="col-md-3 control-label" style="padding-top: 7px; text-align: right;">Từ ngày:</label>
	                            	<div class="col-md-3">	
	                            		<input id="ip-startdate" class="form-control col-md-1 deploymentDatePicker" placeholder="Ngày đầu" type="text" 
	                            		 name="startDate">
	                           		</div>
	                           	</div>
	                           	<br></br>
	                           	<br>
	                           	<div class="col-md-12">
	                            	<label class="col-md-3 control-label" style="padding-top: 7px; text-align: right;">Đến ngày:</label>
	                            	<div class="col-md-3">	
	                            		<input class="form-control col-md-1 deploymentDatePicker" id = "ip-enddate" placeholder="Ngày cuối" type="text"
										name="endDate" >
	                           		</div>
	                           	</div>
	                           <br></br>
	                           <br>
	                           	...
	                           	<div class="col-md-3" style="text-align: center">	
	                            		<button class="btn btn-primary" type="submit" id="btn-export"><i class="fa fa-filter" aria-hidden="true"></i> Xuất báo cáo</button>
	                           		</div>
                            </div>
                        </div>
                    </div>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/file/export.js"></script>
