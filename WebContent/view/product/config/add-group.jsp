...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Tạo mới tỷ lệ giảm phí theo nhóm khách hàng</title>
	       ...
	       <div class="right_col" role="main">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>Tạo mới tỷ lệ giảm phí theo nhóm khách hàng</h2>
								...
								<div class="x_content">
									...
									<form id="discountForm" action="<s:url action = "addGroup" namespace="/web/product/config"/>" class="form-horizontal form-label-left" 
													method="post">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="item form-group">
													...
													<div class="col-md-4 col-sm-4 col-xs-12">
														<s:textfield class="form-control" placeholder="Nhóm khách hàng" type="text" name="discount.customerGroup"/>
													</div>
												</div>
												...
												<div class="item form-group">
													...
													<div class="col-md-4 col-sm-4 col-xs-12">
														<s:textfield class="form-control" placeholder="Tỉ lệ giảm phí" type="text" name="discount.rate"/>
													</div>
												</div>
